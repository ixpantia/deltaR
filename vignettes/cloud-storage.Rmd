---
title: "Using deltaR with Cloud Storage"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using deltaR with Cloud Storage}
...
deltaR provides native support for reading and writing Delta tables to cloud storage services, including:
 - **Amazon S3**
- **Google Cloud Storage (GCS)**
- **Azure Blob Storage / Azure Data Lake Storage (ADLS)**

This guide covers how to configure and use each cloud storage provider with deltaR.

## General Concepts

### Storage Options

All cloud storage operations in deltaR use the `storage_options` parameter to pass authentication credentials and configuration. This is a named list where keys and values depend on the cloud provider.
...
deltaR works with S3-compatible storage services like MinIO, LocalStack, or Ceph:
...
deltaR's cloud storage support is powered by the [object_store](https://github.com/apache/arrow-rs/tree/master/object_store) crate from the Apache Arrow project and the [delta-rs](https://github.com/delta-io/delta-rs) library. We thank the maintainers and contributors of these projects for their excellent work.
