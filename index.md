...
- 🔄 **Schema evolution** - Merge or overwrite schemas as your data
  evolves
- ☁️ **Cloud storage** - Native support for S3, Google Cloud Storage,
  and Azure Blob Storage
- 🚀 **High performance** - Powered by Rust with memory-efficient
  streaming writes
- 📊 **Arrow integration** - Seamless interoperability with the Arrow
  ecosystem
